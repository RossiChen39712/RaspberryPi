...
int main()
{
    ...
    board_set_led(&board, rgb_off, 2);

    // while (1)
    // {
    //     // 設置兩個燈為紅色
    //     int rgb_red[2][4] = {{1, 255, 0, 0}, {2, 255, 0, 0}};
    //     board_set_led(&board, rgb_red, 2);
    //     sleep(1);

    //     // 設置兩個燈為綠色
    //     int rgb_green[2][4] = {{1, 0, 255, 0}, {2, 0, 255, 0}};
    //     board_set_led(&board, rgb_green, 2);
    //     sleep(1);

    //     // 設置兩個燈為藍色
    //     int rgb_blue[2][4] = {{1, 0, 0, 255}, {2, 0, 0, 255}};
    //     board_set_led(&board, rgb_blue, 2);
    //     sleep(1);

    //     // 設置兩個燈為黃色
    //     int rgb_yellow[2][4] = {{1, 255, 255, 0}, {2, 255, 255, 0}};
    //     board_set_led(&board, rgb_yellow, 2);
    //     sleep(1);
